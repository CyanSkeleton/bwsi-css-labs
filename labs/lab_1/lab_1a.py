...
def main():
    ...
    name = "Anubhav" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print("Hello, I'm Anubhav. I'm a junior from California. My hobbies are reading, playing video games, and building Gunpla (Gundam Plastic Model) kits.")
